...
public class IfrTahunAngkatan extends javax.swing.JInternalFrame {
    ...
    private void aksiSimpan(){
        ...
        try{
            ...
            clearTabelTA(); clearForm(); disableForm(); showTabel();
        }catch(SQLException ex){
    ...
    private void aksiHapus(){
        ...
        if(jawab ==JOptionPane.YES_OPTION){
            try{
                ...
                clearTabelTA(); showTabel(); clearForm(); disableForm();
            }catch(SQLException ex){
    ...
    private void createAutoID(){
        try{
            ...
            JOptionPane.showMessageDialog(this, "Error method createAutoID() : "+ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtIdTA, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        ...
        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Tabel Data Tahun Angkatan : Klik 2x untuk mengubah atau menghapus data"));
